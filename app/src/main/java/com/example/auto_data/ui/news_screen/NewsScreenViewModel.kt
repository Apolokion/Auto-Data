...
class NewsScreenViewModel : ViewModel() {
    val newsItems = listOf(
        NewsItem("Tesla releases new model", "The new Tesla com.example.auto_data.api.Model Z is faster, more efficient, and packed with cutting-edge technology.", R.drawable.tesla_news),
